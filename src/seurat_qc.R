library(Seurat)
library(ggplot2)
main = function(data.dir, plot.suffix){
...
ggsave(paste( "qcvln", plot.suffix, sep=""), p1)
ggsave(paste( "fscatter", plot.suffix, sep=""), p4, width=14, height=7)
...
ggsave(paste( "vfeat", plot.suffix, sep=""), p7, width=14, height=7)
...
ggsave(paste( "pca", plot.suffix, sep=""), p8)
}
...
if(length(args) == 2){
   ...
   cat("Need 2 args : data.dir, plot.suffix")
}
